...
public class birdman {
	...
	public static boolean intersect(Point p1, Point q1, Point p2, Point q2) { 
	    ...
	    if (o4 == 0 && onSegment(p2, q1, q2)) return true; 
	  	...
	  	// if you haven't returned true by now, they don't intersect
	    return false;
	}
	...
	public static void main(String[] args){
		...
		for(int loop = 0; loop < numCases; loop++){
			Point b = new Point(kb.nextInt(),kb.nextInt());
			Point s = new Point(kb.nextInt(),kb.nextInt());
			Point p1 = new Point(kb.nextInt(),kb.nextInt());
			Point p2 = new Point(kb.nextInt(),kb.nextInt());
			System.out.println(intersect(b,s,p1,p2) ? 
